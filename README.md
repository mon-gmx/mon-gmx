...
I am used to get feedback and not ashamed to share that I get negative feedback often, or maybe I just choose to pay attention to the negatives more, I think that's a human condition after all. Anyway, back to the core of the conversation, today I rewrote my resume. I cannot say it was too hard (copilot helped me proof read it), but it was very satisfying to come back and go through all the things I have done, because as I was told, "I made a poor job showing that I had made any impact", and well, that did have an impact in me, and I am grateful for it.
...
I am working out my thoughts as well, found a fantastic trainer in ChatGPT, ironically, I burn through resources this kind world has given, because I found in AI the mentor I could never have before. And that makes me embarrassed and grateful for the times we live in 🧠❤️

### A few weeks after (11/24)
So it has been a few weeks after I started working as SRE again. I like it, it is fun. Something has changed, though. I think I am convinced on the ideas that smarter people than me had and one of those is "fail fast". I used to wait for things to happen, but I think I like better making thing happen while others wait. Dunno, maybe this is the right mindset to go further?
Anyway, I started a few interesting projects: a golinks clone, a consumer-publisher job, a simple service to play with traces, I think I am inspired by all the things that have been going on, not to say I want really bad another opportunity in the Bay Area.

### Why GPT is by far my best pair programming amigo (11/24)
Using ChatGPT to code is like shooting at your own feet, except that IMO, it has been the best companion ever. I would guess co-pilot would be fairly efficient, but I find the capacity of bouncing ideas with the GAI a big up that if handled with care can boost productivity.
...
So what am I suggesting here? Should you replace all your tools for using GPT? Nah, but there are a few you for sure will want to get rid off: Google being the first one. If you can search through your prompt, the only other thing you need is access to github (GPT is not actual and deprecation and old code are no strange to it). So having the changelog, API descriptions and a peer that reviews your ideas is like a powerful trifecta, that in my case, has helped me ship at least 5 projects in less than a couple months. Am I grateful for it? You bet! Am I afraid it will replace me? Nah, it will get better when it can handle context and when that happens, I will be grateful for the transition :robot:💙
