...
I won't deny, these answers are bit generic, but seem well intentioned. Maybe I should add as point 6 improve my prompting skills to extract better recommendations. Maybe point 7 would be: be an activist of regulating AI and intellectual property? My master's thesis (with a flawed English) focused on the challenges IP had in my country due to piracy... seems about right to take another dive into the topic.
